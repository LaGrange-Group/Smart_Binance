...
{
    public class SLVC : ViewComponent
    {
        public async Task<IViewComponentResult> InvokeAsync(int id)
        {
            ...
            tradeView.VisualPercentage = tradeView.CurrentPercentage != 0 ? getTrade.VisualPercent(tradeView.Trade.StopLossPrice, tradeView.Trade.BuyPrice + (tradeView.Trade.BuyPrice * ((tradeView.CurrentPercentage / 100) * 2)), tradeView.Trade.BuyPrice, tradeView.CurrentPrice) : 00.00m;
